...
$TranslationPrompt = "Please translate all content read from the attached PDF document into Traditional Chinese (繁體中文).
...
4. **Output Format:** The final translated result must be outputted in **Markdown format**."
